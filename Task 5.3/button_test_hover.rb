...
# The "Click Me" text is not appearing on the button, 
# also both the mouse_x and mouse_y co-ordinate should
...
class DemoWindow < Gosu::Window
  ...
  def draw
    ...
    Gosu.draw_rect(0, 0, 640, 400, @background, ZOrder::BACKGROUND)
    # ????
    # Draw the button
    ...
    @info_font.draw_text("mouse_y: #{mouse_y}", 0, 340, ZOrder::TOP, 1.0, 1.0, Gosu::Color::BLACK)
