...
class MusicPlayerMain < Gosu::Window
	...
	def display_album_information(album)
		@song_font.draw("Album:  #{album.artist.to_s}", 20, 160, ZOrder::TOP, 1.0, 1.0, Gosu::Color::WHITE)
		@song_font.draw("Artist:  #{album.title.to_s}", 20, 180, ZOrder::TOP, 1.0, 1.0, Gosu::Color::WHITE)
		@song_font.draw("Genre:  #{$genre_names[album.genre]}", 20, 200, ZOrder::TOP, 1.0, 1.0, Gosu::Color::WHITE)
		@song_font.draw("Track List: ", 20, 220, ZOrder::TOP, 1.0, 1.0, Gosu::Color::WHITE)
		@song_font.draw("Track Location List: ", 330, 220, ZOrder::TOP, 1.0, 1.0, Gosu::Color::WHITE)
  ...
  def print_track(track, xpos2, xpos, ypos, index)
		@song_font.draw("#{index}: #{track.name}", xpos, ypos, ZOrder::TOP, 1.0, 1.0, Gosu::Color::WHITE)
		@song_font.draw("#{index}: #{track.location}", xpos2, ypos, ZOrder::TOP, 1.0, 1.0, Gosu::Color::WHITE)
  end
  ...
  def playTrack(track, album)
	...
	def draw()
		...
		@title_font.draw("GUI Music Player", 200, 10, ZOrder::TOP, 1.0, 1.0, Gosu::Color::WHITE)
	...
	def draw_album()
		@info_font.draw("mouse_x: #{mouse_x}", 0, 780, ZOrder::TOP, 1.0, 1.0, Gosu::Color::WHITE)
		@info_font.draw("mouse_y: #{mouse_y}", 0, 790, ZOrder::TOP, 1.0, 1.0, Gosu::Color::WHITE)
